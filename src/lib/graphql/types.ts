...
export enum ContentTypeEnum {
  ...
  Post = 'POST',
  /** The Type of Content object */
  YouthSoccerLeagues = 'YOUTH_SOCCER_LEAGUES'
}
...
/** Input for the createYouthSoccerLeague mutation. */
export type CreateYouthSoccerLeagueInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The content of the object */
  content?: InputMaybe<Scalars['String']['input']>;
...
/** The payload for the createYouthSoccerLeague mutation. */
export type CreateYouthSoccerLeaguePayload = {
  __typename?: 'CreateYouthSoccerLeaguePayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  youthSoccerLeague?: Maybe<YouthSoccerLeague>;
};
...
/** Input for the deleteYouthSoccerLeague mutation. */
export type DeleteYouthSoccerLeagueInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars['Boolean']['input']>;
  /** The ID of the YouthSoccerLeague to delete */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
};

/** The payload for the deleteYouthSoccerLeague mutation. */
export type DeleteYouthSoccerLeaguePayload = {
  __typename?: 'DeleteYouthSoccerLeaguePayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']['output']>;
...
export type Menu = DatabaseIdentifier & Node & {
  ...
  menuLocation?: Maybe<Scalars['String']['output']>;
...
export type MenuItemObjectUnion = Category | Page | Post | Tag | YouthSoccerLeague;
...
export enum MenuLocationEnum {
  ...
  Footer = 'FOOTER',
  /** Put the menu in the footer-community location */
  FooterCommunity = 'FOOTER_COMMUNITY',
  /** Put the menu in the footer-contact location */
  FooterContact = 'FOOTER_CONTACT',
  /** Put the menu in the footer-services location */
...
export type RootMutation = {
  ...
  /** The createYouthSoccerLeague mutation */
  createYouthSoccerLeague?: Maybe<CreateYouthSoccerLeaguePayload>;
  ...
  /** The deleteYouthSoccerLeague mutation */
  deleteYouthSoccerLeague?: Maybe<DeleteYouthSoccerLeaguePayload>;
  /** Increase the count. */
  ...
  /** The updateYouthSoccerLeague mutation */
  updateYouthSoccerLeague?: Maybe<UpdateYouthSoccerLeaguePayload>;
};
...
/** The root mutation */
export type RootMutationCreateYouthSoccerLeagueArgs = {
  input: CreateYouthSoccerLeagueInput;
};
...
/** The root mutation */
export type RootMutationDeleteYouthSoccerLeagueArgs = {
  input: DeleteYouthSoccerLeagueInput;
};
...
/** The root mutation */
export type RootMutationUpdateYouthSoccerLeagueArgs = {
  input: UpdateYouthSoccerLeagueInput;
};
...
export type RootQuery = {
  ...
  /** An object of the YouthSoccerLeague Type. This is a robust list of all youth club soccer leagues. */
  youthSoccerLeague?: Maybe<YouthSoccerLeague>;
  /**
   * A YouthSoccerLeague object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  youthSoccerLeagueBy?: Maybe<YouthSoccerLeague>;
  /** Connection between the RootQuery type and the YouthSoccerLeague type */
  youthSoccerLeagues?: Maybe<RootQueryToYouthSoccerLeagueConnection>;
};
...
/** The root entry point into the Graph */
export type RootQueryYouthSoccerLeagueArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']['input']>;
  id: Scalars['ID']['input'];
  idType?: InputMaybe<YouthSoccerLeagueIdType>;
};


/** The root entry point into the Graph */
export type RootQueryYouthSoccerLeagueByArgs = {
  id?: InputMaybe<Scalars['ID']['input']>;
  slug?: InputMaybe<Scalars['String']['input']>;
  uri?: InputMaybe<Scalars['String']['input']>;
  youthSoccerLeagueId?: InputMaybe<Scalars['Int']['input']>;
};


/** The root entry point into the Graph */
export type RootQueryYouthSoccerLeaguesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToYouthSoccerLeagueConnectionWhereArgs>;
};
...
/** Connection between the RootQuery type and the YouthSoccerLeague type */
export type RootQueryToYouthSoccerLeagueConnection = Connection & YouthSoccerLeagueConnection & {
  __typename?: 'RootQueryToYouthSoccerLeagueConnection';
  /** Edges for the RootQueryToYouthSoccerLeagueConnection connection */
  edges: Array<RootQueryToYouthSoccerLeagueConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<YouthSoccerLeague>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToYouthSoccerLeagueConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToYouthSoccerLeagueConnectionEdge = Edge & YouthSoccerLeagueConnectionEdge & {
  __typename?: 'RootQueryToYouthSoccerLeagueConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: YouthSoccerLeague;
};

/** Page Info on the &quot;RootQueryToYouthSoccerLeagueConnection&quot; */
export type RootQueryToYouthSoccerLeagueConnectionPageInfo = PageInfo & WpPageInfo & YouthSoccerLeagueConnectionPageInfo & {
  __typename?: 'RootQueryToYouthSoccerLeagueConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the RootQueryToYouthSoccerLeagueConnection connection */
export type RootQueryToYouthSoccerLeagueConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']['input']>;
...
/** The template assigned to the node */
export type Template_CustomLandingPage = ContentTemplate & {
  __typename?: 'Template_CustomLandingPage';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
};
...
/** Input for the updateYouthSoccerLeague mutation. */
export type UpdateYouthSoccerLeagueInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The content of the object */
  content?: InputMaybe<Scalars['String']['input']>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: InputMaybe<Scalars['String']['input']>;
  /** The ID of the YouthSoccerLeague object */
  id: Scalars['ID']['input'];
  /** Override the edit lock when another user is editing the post */
  ignoreEditLock?: InputMaybe<Scalars['Boolean']['input']>;
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
...
/** The payload for the updateYouthSoccerLeague mutation. */
export type UpdateYouthSoccerLeaguePayload = {
  __typename?: 'UpdateYouthSoccerLeaguePayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The Post object mutation type. */
  youthSoccerLeague?: Maybe<YouthSoccerLeague>;
...
/** The YouthSoccerLeague type */
export type YouthSoccerLeague = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'YouthSoccerLeague';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
  ancestors?: Maybe<YouthSoccerLeagueToYouthSoccerLeagueConnection>;
  /** The content of the post. */
  content?: Maybe<Scalars['String']['output']>;
  /** Connection between the ContentNode type and the ContentType type */
  contentType?: Maybe<ContentNodeToContentTypeConnectionEdge>;
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']['output']>;
  /** Whether the youth_soccer_leagues object is password protected. */
  hasPassword?: Maybe<Scalars['Boolean']['output']>;
  /** The globally unique identifier of the youth_soccer_leagues object. */
  id: Scalars['ID']['output'];
  /** Whether the node is a Comment */
  isComment: Scalars['Boolean']['output'];
  /** Whether the node is a Content Node */
   ...
   * @deprecated This content type is not hierarchical and typically will not have a parent
   */
  parent?: Maybe<YouthSoccerLeagueToParentConnectionEdge>;
  /** The password for the youth_soccer_leagues object. */
  password?: Maybe<Scalars['String']['output']>;
  /** Connection between the YouthSoccerLeague type and the YouthSoccerLeague type */
  preview?: Maybe<YouthSoccerLeagueToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']['output']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']['output']>;
   ...
   * @deprecated Deprecated in favor of the databaseId field
   */
  youthSoccerLeagueId: Scalars['Int']['output'];
};


/** The YouthSoccerLeague type */
export type YouthSoccerLeagueAncestorsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The YouthSoccerLeague type */
export type YouthSoccerLeagueContentArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The YouthSoccerLeague type */
export type YouthSoccerLeagueEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The YouthSoccerLeague type */
export type YouthSoccerLeagueEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The YouthSoccerLeague type */
export type YouthSoccerLeagueTitleArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};

/** Connection to YouthSoccerLeague Nodes */
export type YouthSoccerLeagueConnection = {
  /** A list of edges (relational context) between RootQuery and connected YouthSoccerLeague Nodes */
  edges: Array<YouthSoccerLeagueConnectionEdge>;
  /** A list of connected YouthSoccerLeague Nodes */
  nodes: Array<YouthSoccerLeague>;
  /** Information about pagination in a connection. */
  pageInfo: YouthSoccerLeagueConnectionPageInfo;
};

/** Edge between a Node and a connected YouthSoccerLeague */
export type YouthSoccerLeagueConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected YouthSoccerLeague Node */
  node: YouthSoccerLeague;
};

/** Page Info on the connected YouthSoccerLeagueConnectionEdge */
export type YouthSoccerLeagueConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** The Type of Identifier used to fetch a single resource. Default is ID. */
export enum YouthSoccerLeagueIdType {
  /** Identify a resource by the Database ID. */
  DatabaseId = 'DATABASE_ID',
  /** Identify a resource by the (hashed) Global ID. */
  Id = 'ID',
...
/** Connection between the YouthSoccerLeague type and the YouthSoccerLeague type */
export type YouthSoccerLeagueToParentConnectionEdge = Edge & OneToOneConnection & YouthSoccerLeagueConnectionEdge & {
  __typename?: 'YouthSoccerLeagueToParentConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /**
   * The node of the connection, without the edges
...
/** Connection between the YouthSoccerLeague type and the YouthSoccerLeague type */
export type YouthSoccerLeagueToPreviewConnectionEdge = Edge & OneToOneConnection & YouthSoccerLeagueConnectionEdge & {
  __typename?: 'YouthSoccerLeagueToPreviewConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: YouthSoccerLeague;
...
/** Connection between the YouthSoccerLeague type and the YouthSoccerLeague type */
export type YouthSoccerLeagueToYouthSoccerLeagueConnection = Connection & YouthSoccerLeagueConnection & {
  __typename?: 'YouthSoccerLeagueToYouthSoccerLeagueConnection';
  /** Edges for the YouthSoccerLeagueToYouthSoccerLeagueConnection connection */
  edges: Array<YouthSoccerLeagueToYouthSoccerLeagueConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<YouthSoccerLeague>;
  /** Information about pagination in a connection. */
  pageInfo: YouthSoccerLeagueToYouthSoccerLeagueConnectionPageInfo;
};

/** An edge in a connection */
export type YouthSoccerLeagueToYouthSoccerLeagueConnectionEdge = Edge & YouthSoccerLeagueConnectionEdge & {
  __typename?: 'YouthSoccerLeagueToYouthSoccerLeagueConnectionEdge';
  /**
   * A cursor for use in pagination
   * @deprecated This content type is not hierarchical and typically will not have ancestors
   */
...
/** Page Info on the &quot;YouthSoccerLeagueToYouthSoccerLeagueConnection&quot; */
export type YouthSoccerLeagueToYouthSoccerLeagueConnectionPageInfo = PageInfo & WpPageInfo & YouthSoccerLeagueConnectionPageInfo & {
  __typename?: 'YouthSoccerLeagueToYouthSoccerLeagueConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
export type GetArticleQuery = { __typename?: 'RootQuery', postBy?: { __typename?: 'Post', id: string, title?: string | null, content?: string | null, date?: string | null, slug?: string | null } | null };

export type GetArticlesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetArticlesQuery = { __typename?: 'RootQuery', posts?: { __typename?: 'RootQueryToPostConnection', nodes: Array<{ __typename?: 'Post', id: string, title?: string | null, excerpt?: string | null, date?: string | null, featuredImage?: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node: { __typename?: 'MediaItem', sourceUrl?: string | null, altText?: string | null } } | null, author?: { __typename?: 'NodeWithAuthorToUserConnectionEdge', node: { __typename?: 'User', id: string, name?: string | null, email?: string | null, slug?: string | null, description?: string | null } } | null }>, pageInfo: { __typename?: 'RootQueryToPostConnectionPageInfo', hasNextPage: boolean, endCursor?: string | null } } | null };
